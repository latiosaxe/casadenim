...
// Base `shopify` path
module.exports.shopifyPath = (basePath = '', destPath = '') =>
	path.resolve(__dirname, '../shopify', basePath, destPath);
...
module.exports.getShopifyEnvList = () => {
	return (shopifySettings = fs.existsSync(exports.shopifyConfig())
		? yaml.safeLoad(fs.readFileSync(exports.shopifyConfig(), 'utf8'))
		: {});
};
