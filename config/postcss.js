...
module.exports = () => {
		...
		require('postcss-import')({
			...
			plugins: [
				require('postcss-lazy-rules')({
					...
					stylesheet: utils.srcStylesPath('1-abstracts/_sprite.css')
				})
			],
	...
	plugins.push(
		require('postcss-url')([
			{
				filter: /\.(woff2?)$/,
				url: (asset, dir) => utils.copyAsset(asset, dir, utils.buildFontsPath)
			},

			{
				filter: /\.(jpe?g|png|gif|svg)$/,
				url: (asset, dir) => utils.copyAsset(asset, dir, utils.buildImagesPath)
			}
		])
	);
